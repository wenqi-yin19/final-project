			...
			<div class="panel panel-default">
				<div class="panel-body">
						...
						$arrayquatity=explode("@",$_SESSION['quatity']); 
						 ...
						 while(list($name,$value)=each($_POST)){ 
							  for($i=0;$i<count($array)-1;$i++){
								...
								echo "<script language='javascript'>alert('no！');location.href='cart.php';</script>";
								die;
							   }
					...
					?>
                          ...
                          <td height="35"><a href="removecart.php?id=<?php echo $info['id']?>">Remove</a></td>
                        </tr>
                     <?php
						  }
						 }
                     ...
                     <tbody>
                        ...
                        <tr>
                          ...
                          <td align="center"><a href="cart2.php"><button type="button" class="btn btn-default">Pay</button></a></td>
                          <td align="center"><a href="cart.php?qk=yes"><button type="button" class="btn btn-default">Clear Cart</button></a></td>
                          <td align="center"><a href="goods.php"><button type="button" class="btn btn-default">Keep Shopping</button></a></td>
