    ...
    <div class="container">
        <div class="row">
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="<?php echo __PUBLIC__;?>/images/banner1.png">
                        ...
                        <div class="item">
                            <img src="<?php echo __PUBLIC__;?>/images/banner2.png">
                            <div class="header-text hidden-xs">
                                <div class="col-md-12 text-center">
                                </div>
                            </div>
            ...
            <div class="col-lg-12" style="margin-left: 100px;">
                <div class="heading"><h2>Recommend Goods</h2></div>
                <div class="products">
                    <?php
                    $goodsb = db_get_all("select * from goods where status=0 order by id desc limit 8"); 
                    foreach($goodsb as $row) {?>
