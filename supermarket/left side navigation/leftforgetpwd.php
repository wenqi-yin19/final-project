<?php 
	...
	if ($_POST){
		...
		if ($row["id"]) {
			...
			urlMsg('Successfully, reset password','leftforgetnew.php');
		}
		else{urlMsg("Wrong, Try Again",'leftforgetpwd.php');	}
		die;
	}
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-9" style="margin-left: 250px;">
			<ul class="breadcrumb">
				<li><span class="glyphicon glyphicon-home"></span> <a href="leftindex.php"> Homeoage</a></li>
