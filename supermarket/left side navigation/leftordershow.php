  ...
  if($act == 'shouhuo')
	{
		...
		echo "<script>alert('Delivery！');location.href='leftorder.php';</script>";
	}
				...
				<div class="panel-body">
                    <table class="table table-bordered">
                     ...
                     <?php
					  ...
					  ?>
                      	<tr>
                          <td height="35"><a href="leftgoodshow.php?id=<?php echo $info1['id'];?>&categoryid=<?php echo $info1['categoryid'];?>"><?php echo $info1['title'];?></a></td>
