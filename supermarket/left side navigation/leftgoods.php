	...
	<div class="row">
        <div class="col-md-9" style="margin-left: 250px;">
			<ul class="breadcrumb">
				...
				<li><a href="leftgoods.php">Good Center</a></li>
			</ul>
                        ...
                        <div class="list-group"><table width="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="abd6fa" style="border:1px solid abd6fa">
                            ...
                            <?php foreach($list["data"] as $row) {?>
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="product">
                                        <div class="image"><a href="leftgoodshow.php?id=<?php echo $row['id'];?>&categoryid=<?php echo $row['categoryid'];?>">
                                        <?php if (!$row["img"]){?>
                                        ...
                                        <div class="caption">
                                            <div class="name"><h3><a href="leftgoodshow.php?id=<?php echo $row['id'];?>&categoryid=<?php echo $row['categoryid'];?>"><?php echo $row['title'];?></a></h3></div>
                                            <div class="price">￡<?php echo $row['sprice'];?><span>￡<?php echo $row['mprice'];?></span></div>
                                            <div class="rating"><div class="buttons">
                                            <a class="btn cart" href="leftaddcart.php?id=<?php echo $row['id'];?>"><span class="glyphicon glyphicon-shopping-cart"></span></a>
                                        </div></div>
                                        </div>
                                    </div>
                                </div>
